...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdbaoHiem).HasName("PK__BAOHIEM__6C83817730CF01E1");
            ...
            entity.HasOne(d => d.IdnvNavigation).WithMany(p => p.Baohiems)
                ...
                .HasConstraintName("FK__BAOHIEM__IDNV__73BA3083");
        });

        modelBuilder.Entity<Chamcong>(entity =>
        {
            entity.HasKey(e => e.IdchamCong).HasName("PK__CHAMCONG__AC232BEE5010A1B8");
            ...
            entity.HasOne(d => d.IdloaiCongNavigation).WithMany(p => p.Chamcongs)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CHAMCONG__IDLoai__7D439ABD");

            entity.HasOne(d => d.IdnvNavigation).WithMany(p => p.Chamcongs)
                .HasForeignKey(d => d.Idnv)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CHAMCONG__IDNV__7C4F7684");
        });

        modelBuilder.Entity<Congviec>(entity =>
        {
            entity.HasKey(e => e.IdcongViec).HasName("PK__CONGVIEC__6D97AEE46D0052C1");
        ...
        {
            entity.HasKey(e => e.SoHopDong).HasName("PK__HOPDONG__71C5D5BAD6C24B28");
            ...
            entity.HasOne(d => d.IdloaiHdNavigation).WithMany(p => p.Hopdongs)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HOPDONG__IDLoaiH__787EE5A0");

            entity.HasOne(d => d.IdnvNavigation).WithMany(p => p.Hopdongs)
                .HasForeignKey(d => d.Idnv)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HOPDONG__IDNV__778AC167");
        });

        modelBuilder.Entity<KhenthuongKiluat>(entity =>
        {
            entity.HasKey(e => e.IdktKl).HasName("PK__KHENTHUO__326968EC056FA22C");
            ...
            entity.HasOne(d => d.IdnvNavigation).WithMany(p => p.KhenthuongKiluats)
                .HasForeignKey(d => d.Idnv)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__KHENTHUONG__IDNV__70DDC3D8");
        });

        modelBuilder.Entity<Loaicong>(entity =>
        {
            entity.HasKey(e => e.IdloaiCong).HasName("PK__LOAICONG__8E9A196CED296A87");
        ...
        {
            entity.HasKey(e => e.IdloaiHopDong).HasName("PK__LOAIHOPD__6C2A0CFFAEA906A5");
        ...
        {
            entity.HasKey(e => e.Idnv).HasName("PK__NHANVIEN__B87DC9B2DC1169F7");
            ...
            entity.HasOne(d => d.IdcongViecNavigation).WithMany(p => p.Nhanviens)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__NHANVIEN__IDCong__6D0D32F4");

            entity.HasOne(d => d.IdphongBanNavigation).WithMany(p => p.Nhanviens)
                .HasForeignKey(d => d.IdphongBan)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__NHANVIEN__IDPhon__6C190EBB");

            entity.HasOne(d => d.IdtaiKhoanNavigation).WithMany(p => p.Nhanviens)
                .HasForeignKey(d => d.IdtaiKhoan)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__NHANVIEN__IDTaiK__6B24EA82");

            entity.HasOne(d => d.IdtrinhDoNavigation).WithMany(p => p.Nhanviens)
                .HasForeignKey(d => d.IdtrinhDo)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__NHANVIEN__IDTrin__6E01572D");
        });

        modelBuilder.Entity<Phongban>(entity =>
        {
            entity.HasKey(e => e.IdphongBan).HasName("PK__PHONGBAN__1F6C42EF1D550BD6");
        ...
        {
            entity.HasKey(e => e.IdtaiKhoan).HasName("PK__TAIKHOAN__BC5F907C5ED642EC");
        ...
        {
            entity.HasKey(e => e.IdtrinhDo).HasName("PK__TRINHDO__2BBB8234049A0F8B");
        ...
        {
            entity.HasKey(e => e.IdvaiTro).HasName("PK__VAITRO__45D3FF4957813C15");
